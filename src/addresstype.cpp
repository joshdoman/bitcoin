...
public:
    ...
    CScript operator()(const WitnessV3Singleton& hash) const
    {
        return CScript() << OP_3 << ToByteVector(hash);
    }
...
public:
    ...
    bool operator()(const WitnessV3Singleton& dest) const { return true; }
