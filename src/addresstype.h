...
struct WitnessV3Singleton : public BaseHash<uint256>
{
    WitnessV3Singleton() : BaseHash() {}
    explicit WitnessV3Singleton(const uint256& hash) : BaseHash(hash) {}
};
 ...
 *  * WitnessV3Singleton: TxoutType::WITNESS_V3_SINGLETON destination (P2SG address)
 *  * PayToAnchor: TxoutType::ANCHOR destination (P2A address)
 *  * WitnessUnknown: TxoutType::WITNESS_UNKNOWN destination (P2W??? address)
 *  A CTxDestination is the internal data type encoded in a bitcoin address
 */
using CTxDestination = std::variant<CNoDestination, PubKeyDestination, PKHash, ScriptHash, WitnessV0ScriptHash, WitnessV0KeyHash, WitnessV1Taproot, WitnessV3Singleton, PayToAnchor, WitnessUnknown>;
