...
std::vector<unsigned int> AllFlags()
{
    ...
    for (unsigned int i = 0; i < 128; ++i) {
        ...
        if (i & 128) flag |= SCRIPT_VERIFY_TAPROOT_EXCEEDING_32_BYTES;
        ...
        // SCRIPT_VERIFY_TAPROOT_EXCEEDING_32_BYTES requires SCRIPT_VERIFY_TAPROOT
        if (flag & SCRIPT_VERIFY_TAPROOT_EXCEEDING_32_BYTES && !(flag & SCRIPT_VERIFY_TAPROOT)) continue;
