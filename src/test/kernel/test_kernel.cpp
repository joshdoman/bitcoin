...
void run_verify_test(
    ...
    const PrecomputedTransactionData* precomputed_data,
    int64_t amount,
...
BOOST_AUTO_TEST_CASE(btck_script_verify_tests)
{
    ...
    auto spending_tx{Transaction{hex_string_to_byte_vec("")}};
    ...
    auto precomputed_data{PrecomputedTransactionData{spending_tx, spent_outputs}};
    run_verify_test(
...
BOOST_AUTO_TEST_CASE(btck_chainman_regtest_tests)
{
    ...
    for (const auto block_tree_entry : chain.Entries()) {
        ...
        for (const auto transaction : block->Transactions()) {
            ...
            const PrecomputedTransactionData precomputed_data{transaction, spent_outputs};
            for (size_t i{0}; i < inputs.size(); ++i) {
                BOOST_CHECK(spent_outputs[i].GetScriptPubkey().Verify(spent_outputs[i].Amount(), transaction, &precomputed_data, i, ScriptVerificationFlags::ALL, status));
            }
        }
    }
