...
/**
 * @brief Create precomputed transaction data for efficient script verification.
 *
 ...
 *
 * @param[in] precomputed_data  Non-null.
...
BITCOINKERNEL_API btck_PrecomputedTransactionData* BITCOINKERNEL_WARN_UNUSED_RESULT btck_precomputed_transaction_data_copy(
    const btck_PrecomputedTransactionData* precomputed_data) BITCOINKERNEL_ARG_NONNULL(1);

/**
 * Destroy the precomputed transaction data.
 */
BITCOINKERNEL_API void btck_precomputed_transaction_data_destroy(btck_PrecomputedTransactionData* precomputed_data);
 ...
 * @param[in] precomputed_data  Nullable if the taproot flag is not set. Otherwise, precomputed transaction
 *                              data with the spent outputs must be provided.
